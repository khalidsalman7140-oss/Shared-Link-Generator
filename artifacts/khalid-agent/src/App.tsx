...
const clerkAppearance = {
  ...
  elements: {
    ...
    cardBox:
      "bg-[#0F1022] rounded-2xl w-[440px] max-w-full overflow-hidden border border-[#2A2A3E]",
    ...
    socialButtonsBlockButton:
      "border border-[#2A2A3E] bg-[#1A1B2E] hover:bg-[#252640] text-gray-200",
      ...
      localization={{
        ...
        signUp: {
          start: {
            ...
            subtitle: "انضم إلى منصة خالد سلمان الذكية",
          },
        },
      }}
