        ...
        <div className="bg-card border border-primary/40 rounded-2xl p-4 shadow-2xl shadow-primary/20">
          <div className="flex items-start justify-between mb-3">
            <h3 className="font-bold text-sm text-foreground">
              {lang === "ar" ? "تنصيب على iPhone / iPad" : "Install on iPhone / iPad"}
            </h3>
          ...
          <ol className="space-y-2 text-xs text-muted-foreground">
            <li className="flex items-start gap-2">
              <span className="bg-primary text-primary-foreground rounded-full w-5 h-5 flex items-center justify-center text-[10px] shrink-0 mt-0.5">1</span>
              {lang === "ar" ? 'اضغط على زر "مشاركة" ⬆️ في Safari' : 'Tap the "Share" ⬆️ button in Safari'}
            </li>
            <li className="flex items-start gap-2">
              <span className="bg-primary text-primary-foreground rounded-full w-5 h-5 flex items-center justify-center text-[10px] shrink-0 mt-0.5">2</span>
              {lang === "ar" ? 'اختر "إضافة إلى الشاشة الرئيسية"' : 'Select "Add to Home Screen"'}
            </li>
            <li className="flex items-start gap-2">
              <span className="bg-primary text-primary-foreground rounded-full w-5 h-5 flex items-center justify-center text-[10px] shrink-0 mt-0.5">3</span>
              {lang === "ar" ? 'اضغط "إضافة" — التطبيق جاهز ✅' : 'Tap "Add" — App is ready ✅'}
            </li>
          </ol>
        </div>
      </div>
        ...
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            <p className="font-bold text-sm text-foreground">
              {lang === "ar" ? "نصِّب التطبيق مجاناً" : "Install App for Free"}
            </p>
            <p className="text-xs text-muted-foreground">
              {lang === "ar" ? "يعمل بدون إنترنت ويفتح كتطبيق حقيقي" : "Works offline & opens like a real app"}
            </p>
          </div>
        </div>
